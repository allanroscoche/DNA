...
\subsection{Layout de Fragmentos}
...
se existir uma sobreposição[pevzner] entre elas. A comparação entre
duas leituras é realizada utilizado o algoritmo de Smith e Waterman. O
