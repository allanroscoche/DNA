...
Para isso são utilizados sequenciadores, máquinas que automatizam os
processos químicos utilizados para a identificação dos nucleotídios das
leituras.
Os sequenciadores produzem leituras do DNA em forma de uma sequencia de
bases nucléicas.
